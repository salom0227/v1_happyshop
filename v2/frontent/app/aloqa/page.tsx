  ...
  return (
    <div className="min-h-screen bg-transparent">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 pb-24">
        <h1 className="text-xl sm:text-2xl font-bold text-foreground mb-3 sm:mb-4">Aloqa</h1>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex flex-col sm:flex-row gap-2 pt-3">
                  <Button asChild className="flex-1 h-10 min-h-[44px]">
                    <a href="tel:+998933434332"><Phone className="h-4 w-4 mr-1.5" />Qo&apos;ng&apos;iroq qilish</a>
                  </Button>
                  <Button asChild variant="outline" className="flex-1 h-10 min-h-[44px]">
                    <a href="https://t.me/mu7alov" target="_blank" rel="noreferrer"><Send className="h-4 w-4 mr-1.5" />Telegramdan yozish</a>
                  </Button>
                </div>
              </CardContent>
            </Card>
